...
def optimize_support(filepath, n_support_set, n_combs_max = 50, verbosity=0):
    ...
    for index_ranges in tqdm(merge_ranges):
    ...
    outfile = f"/usr/xtmp/vb97/GAM_Rashomon_Sets/gam-rashoman-set/models/{opt.dname}_{opt.lamb0}_{opt.lamb2}_{opt.multiplier}_merge_bins_{n_support_set}.p"
